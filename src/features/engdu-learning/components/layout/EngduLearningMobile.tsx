    ...
    >
      ...
      {activeTab === '지문' && (
        <div
          ...
          className={cn(
            'scrollbar-none relative flex h-full w-full flex-col gap-4 overflow-y-auto bg-surface-weak pb-[calc(4.5rem+env(safe-area-inset-bottom))]',
      ...
      {activeTab === '퀴즈' && (
        <div
          className={cn(
            'relative flex h-full w-full flex-col bg-surface-weak pb-[calc(4.5rem+env(safe-area-inset-bottom))] pt-4',
            isMobile ? 'px-5' : 'max-w-120 px-7',
          )}
        >
          {/* 상단 퀴즈 스텝바 고정 */}
